...
$string['my_external_backup_restore_courses:can_restore_user_datas'] = 'Possibilité de restaurer les cours avec les données utilisateurs';
...
$string['restorecourseinoriginalcategory_desc'] = 'Restaure les cours dans leurs catégories si possible.';
$string['defaultcategorychecked'] = 'Valeur par défaut de la case du choix d\'utilisation de la catégorie originale';
$string['defaultcategorychecked_desc'] = 'Valeur par défaut de la case du choix d\'utilisation de la catégorie originale';
...
$string['enrollrole_desc'] = 'Le role qui serra donné au demandeur de la restauration mais aussi à l\utilisateur lorsqu\'il cliquera sur le bouton s\'inscrire au cours';
...
$string['privacy:metadata:block_my_external_backup_restore_courses:remote_moodle:externalcourseid'] = 'Id du cours du moodle distant à restaurer dans le moodle courant.';
$string['privacy:metadata:block_my_external_backup_restore_courses:remote_moodle:externalmoodleurl'] = 'Adresse url du moodle qui contient les cours à restaurer.';
$string['privacy:metadata:block_my_external_backup_restore_courses:remote_moodle'] = 'Données du moodle distant.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:userid'] = 'Id utilisateur moodle.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalcourseid'] = 'Id du cours moodle distant qui sera ou a été restauré locallement.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalcoursename'] = 'Nom du cours moodle distant qui sera ou a été restauré locallement.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalmoodleurl'] = 'Url du moodle distant.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:internalcategory'] = 'Catégorie où le cours serra restauré.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:status'] = 'Status de la restauration du cours.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:courseid'] = 'Id du cours local restauré.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timecreated'] = 'Date de création de la tâche de restauration pour un cours donné.et un utilisateur donnée';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timemodified'] = 'Date de modification du statut de la tâche de restauration pour un cours donné.et un utilisateur donnée';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timescheduleprocessed'] = 'Date de programmation de la  tâche de restauration.';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore'] = 'Table block_external_backuprestore qui stocke les données relatives à la restauration des cours distants.';
...
$string['checkrequestercapascoursecreate'] = 'Vérifier si le demandeur peut restaurer un cours dans la catégorie demandée.';
$string['checkrequestercapascoursecreate_desc'] = 'Vérifier si le demandeur peut restaurer un cours dans la catégorie demandée. moodle/course:create sera vérifiée.';
$string['adminpage']='Administration des tâches de sauvegarde/restauration';
$string['scheduledtasklist'] = 'Liste des tâche programmée de restauration de cours de Moodle distants';
$string['noscheduledtasks'] = 'Pas de tâches de restaurationde cours programmées';
$string['externalmoodleadminhelpsection']='Avec cet outil vous pouvez gérer les entrées base de données correspondant aux course programmé pour import.<br> Modifiez une ligne en changeant ses valeurs et en la validant en cliquant sur le bouton modifié de cette même ligne.<br>Internalcategory à 0 signifie l\'utilisation de la catégorie par défaut définie via le paramétrage du plugin block.';
$string['defaultcategoryx'] = 'La Catégorie par défaut est "{$a->name}", d\'id {$a->id}';
$string['entriesperpage'] = 'Entrées par page';
$string['courseoruserfilter'] = 'Nom de cours ou d\'utilisateur (identifiant, prénom, nom, nom cours/long)';
$string['courseidfilter'] = 'Id de cours';
$string['useridfilter'] = 'Id utilisateur';
$string['filter'] = 'Filtre';
$string['filters'] = 'Filtres';
$string['withuserdatasheadtable'] = 'Restaurer les données utilisateur dans le cours';
$string['adminrestorecourseforuser'] = 'Restaurer un cours pour un utilisateur';
$string['withuserdatas'] = 'Avec les données utilisateur';
$string['planifyrestore'] = 'Planifer la restauration';
$string['settings'] = 'Paramètres';
$string['externalcourseid'] = 'id du cours externe';
$string['planifyrestore'] = 'Planifier la restauration du cours';
