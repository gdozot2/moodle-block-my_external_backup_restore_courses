...
$string['my_external_backup_restore_courses:can_restore_user_datas'] = 'User has the possibility to course with user datas.';
...
$string['restorecourseinoriginalcategory_desc'] = 'Restore course in its category if possible.';
...
$string['executiontimeyourself'] = 'Performed by yourself';
...
$string['enrollrole_desc'] = 'role that will be assigned to requester of restoration and to user after clicking enroll button';
...
$string['privacy:metadata:block_my_external_backup_restore_courses:remote_moodle:externalcourseid'] = 'on remote moodle from wich course will be restored a backup file is created.';
$string['privacy:metadata:block_my_external_backup_restore_courses:remote_moodle'] = 'remote moodle datas';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:userid'] = 'moodle userid';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalcourseid'] = 'moodle remote courseid that will be/ was restored locally';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalcoursename'] = 'moodle remote coursename that will be/ was restored locally';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:externalmoodleurl'] = 'remote moodle url';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:internalcategory'] = 'category where the course will be restored';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:status'] = 'status of course restoration';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:courseid'] = 'local courseid of the restored course';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timecreated'] = 'creation time of the restoration task for a given course and a given user';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timemodified'] = 'modification time of the restoration task for a given course and a given user';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore:timescheduleprocessed'] = 'scheduled time for restoration';
$string['privacy:metadata:block_my_external_backup_restore_courses:block_external_backuprestore'] = 'data table block_external_backuprestore that store datas concerning remote course restoration';
...
$string['checkrequestercapascoursecreate'] = 'Check if requester can restore course in the asked category.';
$string['checkrequestercapascoursecreate_desc'] = 'Check if requester can restore course in the asked category. moodle/course:create will be checked ';
...
$string['courseoruserfilter'] = 'Course or user name (username, firstname, lastname)';
$string['courseidfilter'] = 'Course id';
$string['useridfilter'] = 'User id';
$string['filter'] = 'Filter';
$string['filters'] = 'Filters';
$string['withuserdatasheadtable'] = 'Restore user datas in course';
$string['adminrestorecourseforuser'] = 'Restore course for user';
$string['withuserdatas'] = 'With user datas';
